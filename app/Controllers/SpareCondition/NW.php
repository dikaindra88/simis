...
class NW extends BaseController
{
    public function __construct()
    {
        $this->Option = new Options();
        $this->User = new UsersModel();
        $this->Nw = new SparepartModel();
        helper('form');
    }
    public function index()
    {
        ...
        $data = [
            'title' => 'Page | Condition N / W',
            'nw' => $this->Nw->getNW(),
            'user' => $this->User->getData(),
            'first_date'=> '',
            'end_date'=> ''
        ];
        return view('sparecondition/nw/V_nw', $data);
    }else{
        return redirect()->to('/');
    }
    }
    ...
    public function show()
    {
        ...
        $data = [
            'title' => 'Page | Condition N / W',
        'nw' => $this->Nw->getDetailNW($first_date, $end_date),
        'user' => $this->User->getData(),
    ...
    public function excel($first_date, $end_date, $mid_date, $first_date1, $end_date1, $mid_date1)
    {
        ...
        $data = [
            'nw' => $this->Nw->getDetailNW($first, $end),
            'first_date'=> $first,
            'end_date'=> $end

        ];
         //dd($data);
        return view('sparecondition/nw/excel', $data);
    }else{
        return redirect()->to('/');
    }
    }
    public function print($first_date, $end_date, $mid_date, $first_date1, $end_date1, $mid_date1)
    {
        ...
        //dd($data);
       //return 
        $html = view('sparecondition/nw/print', $data);
