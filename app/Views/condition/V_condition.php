...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">List Kondisi</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item active">List Kondisi</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        ...
        <div class="modal-dialog modal-default">
            <div class="modal-content bg-dark">
                <div class="modal-header">
                    <h4 class="modal-title" style="font-family: arial black; color:#F3CB51;font-size:18pt;">&nbsp;Input Kondisi</h4>
                                        ...
                                        <td>
                                            ...
                                            <div class="nav-item dropup">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <form action="<?= base_url('/Kondisi/update') . '/' . $row['id_kondisi'] ?>" method="post">
                                                        <?= csrf_field(); ?>
                                                    ...
                                                    <form action="<?= base_url('/Kondisi/Delete') . '/' . $row['id_kondisi'] ?>" method="post">
                                                        <?= csrf_field(); ?>
