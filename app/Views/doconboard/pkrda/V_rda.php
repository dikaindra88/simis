...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Document Onboard PK-RDA</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item active">Document Onboard PK-RDA</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
            ...
            <a href="<?= base_url('PK-RDA/Convert') ?>" target="_blank" class="btn btn-outline btn-danger ">
                <i class="fas fa-file-pdf"></i> Pdf
            </a>
            <a href="<?= base_url('PK-RDA/Print') ?>" target="_blink" class="btn btn-outline-secondary btn-light">
        ...
        <div class="modal-dialog modal-default">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" style="font-family: arial black; color:#000080;font-size:18pt;">&nbsp;Input Document PK-RDA</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <img class="modal-title" src="<?= base_url('img/RDG.png') ?>" height="30">
                    </button>

                </div>
                <form method="post" action="PK-RDA-add" enctype="multipart/form-data">
                                        ...
                                        <td>
                                            ...
                                            <div class="nav-item dropup">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <form action="<?= base_url('/PK-RDA/pdf') . '/' . $row['id_document'] ?>" method="post" target="__blink">
                                                        <?= csrf_field(); ?>
                                                    ...
                                                    <form action="<?= base_url('/PK-RDA/update') . '/' . $row['id_document'] ?>" method="post">
                                                        <?= csrf_field(); ?>
                                                        <input type="hidden" name="_method" value="Edit">
                                                    ...
                                                    <div class="dropdown-divider"></div>
                                                    <form action="<?= base_url('/PK-RDA/Delete') . '/' . $row['id_document'] ?>" method="post">
                                                        <?= csrf_field(); ?>
