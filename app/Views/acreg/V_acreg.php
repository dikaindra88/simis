...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">List A / C Regist</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item active">List A / C Regist</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        ...
        <div class="modal-dialog modal-default">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" style="font-family: arial black; color:#000080;font-size:18pt;">&nbsp;Input A / C Reg</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <img class="modal-title" src="<?= base_url('img/RDG.png') ?>" height="30">
                    </button>

                </div>
                <form method="post" action="Add-acreg" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>A / C Regist Name</label>
                                    <input type="text" name="acreg_name" class="form-control" placeholder="A / C Reg Name" required>
                                </div>
                                        ...
                                        <td>
                                            ...
                                            <div class="nav-item dropup">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <form action="<?= base_url('/Acregist/update') . '/' . $row['id_acreg'] ?>" method="post">
                                                        <?= csrf_field(); ?>
                                                    ...
                                                    <form action="<?= base_url('/Acreg/Delete') . '/' . $row['id_acreg'] ?>" method="post">
                                                        <?= csrf_field(); ?>
