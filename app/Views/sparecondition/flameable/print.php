...
<head>
    ...
    <title>List Sparepart Flameable <?= date('F Y'); ?>.pdf</title>
...
<body>
    ...
    <table style="border:1px solid #000;border-collapse: collapse;" width="100%" cellpadding="0">
        ...
        font-family: Arial, Helvetica, sans-serif;">
                    ...
                    <td style="border:1px solid #000;padding: 2px;"><?= $rows['create_date'] ?></td>
                    <td style="border:1px solid #000;padding: 2px;"><?= $rows['expired_date'] ?></td>
                    </div>
                </tr>
            <?php endforeach ?>
