...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>List Sparepart N/W</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item active">List Sparepart N/W</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->

            <hr>
            <form action="N_W-search" method="POST" enctype="multipart/form-data">
            <div class="row ml-2">
                ...
                <div class="col-lg-3">
                    ...
                    <a href="<?= base_url('N_W/print') . '/' . $first_date . '/' . $end_date?>" target="_blank" class="btn btn-outline btn-danger ">
                        <i class="fas fa-file-pdf"></i> Pdf
                    </a>
                    <a href="<?= base_url('N_W/Print') .'/'. $first_date . '/' . $end_date?>" target="_blink"class="btn btn-outline-secondary btn-light">
