        ...
        <div class="modal-dialog modal-default">
            <div class="modal-content bg-dark">
                <div class="modal-header">
                    <h4 class="modal-title" style="font-family: arial black; color:#F3CB51;font-size:18pt;">&nbsp;Input Rak</h4>
                        ...
                        <div class="card bg-dark">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_rak" class="form-control" id="part_number" placeholder="Nama Rak" required>
                                </div>
                                        ...
                                        <td>
                                            ...
                                            <div class="nav-item dropup">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <form action="<?= base_url('/Rack/update') . '/' . $row['id_rak'] ?>" method="post">
                                                        <?= csrf_field(); ?>
                                                    ...
                                                    <form action="<?= base_url('/Rack/Delete') . '/' . $row['id_rak'] ?>" method="post">
                                                        <?= csrf_field(); ?>
