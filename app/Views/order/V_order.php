        ...
        <div class="modal-dialog modal-default">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" style="font-family: arial black; color:#000080;font-size:18pt;">&nbsp;Input PO / RO</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <img class="modal-title" src="<?= base_url('img/RDG.png') ?>" height="30">
                    </button>

                </div>
                <form method="post" action="Add-orders" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="order_name" class="form-control" placeholder="Order Name" required>
                                </div>
                                        ...
                                        <td>
                                            ...
                                            <div class="nav-item dropup">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <form action="<?= base_url('/Orders/update') . '/' . $row['id_pro'] ?>" method="post">
                                                        <?= csrf_field(); ?>
                                                    ...
                                                    <form action="<?= base_url('/Orders/Delete') . '/' . $row['id_pro'] ?>" method="post">
                                                        <?= csrf_field(); ?>
