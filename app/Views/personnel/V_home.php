...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Request Barang / Sparepart</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="modal-dialog  modal-xl">
            <div class="modal-content bg-dark">
                <div class="modal-header">
                    <h4 class="modal-title" style="font-family: arial black; color:#F3CB51;font-size:18pt;">&nbsp;Request Pemakaian Barang / Sparepart</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <img class="modal-title" src="<?= base_url('img/ATS.png') ?>" height="50">
                    </button>

                </div>
                <form method="post" action="Add-request" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                <input type="text" name="tgl_request" class="form-control datetimepicker-input" data-target="#reservationdate" placeholder="Tanggal request barang / sparepart" />
                                ...
                                <div class="card bg-dark">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="keperluan" id="serial_number" class="form-control" placeholder="Keperluan">
                                        </div>
                                        <div class="form-group">
                                            <label>Qty</label>
                                        ...
                                        <td>
                                            ...
                                            <div class="nav-item dropup">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <form action="<?= base_url('/Dashboard-personnel/update-request') . '/' . $row['id_request'] ?>" method="post">
                                                        <?= csrf_field(); ?>
